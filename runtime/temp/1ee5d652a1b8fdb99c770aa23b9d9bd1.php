...
<script type="text/javascript">
    ...
    <div class="form-group">
        <label for="c-url" class="control-label col-xs-12 col-sm-2">上传:</label>
        <div class="col-xs-12 col-sm-8">
            <input type="file" id="c-url">
        </div>
    </div>
    <div class="form-group">
